      ...
      <div class="statistics-detail">
        ...
        <div class="time-wrap">
          ...
          <div class="time-item">
            ...
            <span class="item-bot">答题时间</span>
          </div>
        </div>
        <div class="info-item">
          <img src="@/assets/img/practice/info-tip.png" alt="">
          <span class="item-right">正确率:<span class="item-per">{{detail.correct}}</span></span>
          <span class="item-false item-point">答对:<span class="item-num">{{detail.rightCount | defaultCount}}</span><span class="item-false">题</span></span>
        </div>
        <div class="info-item info-long">
          <img src="" alt="">
          <span class="item-right">答错:<span class="item-per item-per-color">{{detail.errorCount | defaultCount}}</span><span class="item-false">题</span></span>
          <span class="item-false item-point">未答:<span class="item-num item-num-color">{{detail.unFinishCount | defaultCount}}</span><span class="item-false">题</span></span>
        </div>
      </div>
    </div>
